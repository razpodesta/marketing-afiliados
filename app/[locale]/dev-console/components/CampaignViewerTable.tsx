...
// CORRECCIÓN: Se ha añadido la importación faltante del componente Card.
 ...
 * CORRECCIÓN DE IMPORTACIÓN: Se ha añadido la importación del componente `Card`,
 * resolviendo un error de compilación.
 *
 * @author Metashark
 * @version 1.1.0 (Import Fix)
 */
type CampaignRow = {
  id: string;
  name: string;
